...
initMotion({"hero": ".hero-copy > .eyebrow, .hero h1, .hero .lead, .hero .button", "art": ".hero figure", "reveal": ".evening > h2, .choices article, .visit h2", "artStart": "translateY(22px) rotate(-3deg) scale(.97)"});
})();
